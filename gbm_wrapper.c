...
int gbm_bo_get_plane_count(struct gbm_bo *bo) { return 1; }
#endif
...
static inline bool can_ignore_modifiers(const uint64_t *modifiers,
...
static inline void *mali_dlsym(const char *func) {
  void *handle, *symbol;
...
/* From mesa3d 21.1.1 : src/gbm/main/gbm.c */
